(function() {
  var Client, Event, User, client, clients, createClient, createEvents, createUser, events, mongoose, user, users;
  ...
  createEvents = function() {
    ...
    event1.isEnabledForModeration = true;
    event1.startDate = Date.now();
    event1.endDate = '2/2/2012';
    event1.fromTweeple.push({
      username: 'xajler'
    });
    event1.fromTweeple.push({
      username: 'adebak'
    });
    event1.toTweeple.push({
      username: 'adebak'
    });
    event1.toTweeple.push({
      username: 'darkoche'
    });
    event1.mentionTweeple.push({
      username: 'darkoche'
    });
    event1.containAllOfWords.push({
      name: 'techno'
    });
    event1.containAllOfWords.push({
      name: 'party'
    });
    event1.containExactPhrases.push({
      name: 'techno party'
    });
    event1.containExactPhrases.push({
      name: 'techno music'
    ...
    event2.isEnabledForModeration = true;
    event2.startDate = Date.now();
    event2.endDate = '2/2/2012';
    event2.fromTweeple.push({
      username: 'xajler'
    });
    event2.fromTweeple.push({
      username: 'adebak'
    });
    event2.toTweeple.push({
      username: 'adebak'
    });
    event2.toTweeple.push({
      username: 'darkoche'
    });
    event2.mentionTweeple.push({
      username: 'darkoche'
    });
    event2.containAllOfWords.push({
      name: 'techno'
    });
    event2.containAllOfWords.push({
      name: 'party'
    });
    event2.containExactPhrases.push({
      name: 'techno party'
    });
    event2.containExactPhrases.push({
      name: 'techno music'
