...
var Client = new Schema({
  ...
  isUserWhitelistedForAllEvents: { type: Boolean, default: false },
  isUserBlacklistedForAllEvents: { type: Boolean, default: false },
  isWordBlacklistedForAllEvents: { type: Boolean, default: false }
});
